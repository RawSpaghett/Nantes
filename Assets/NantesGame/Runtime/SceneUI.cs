...
namespace NantesGame.Gameplay
{
    public sealed class SceneUI : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            anchor.SetParent(player.transform,false);anchor.localScale=Vector3.one*.043f;mount=anchor;
            ...
            chest.extendedPosition=new Vector3(0,.02f,.59f);chest.foldedPosition=new Vector3(0,.1f,.08f);
            ...
            player.gameObject.AddComponent<PlayerSoundEffects>();
