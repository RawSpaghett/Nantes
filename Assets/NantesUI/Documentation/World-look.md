...
Preview of the grocery-store maze from main. The layout, props, and their materials are unchanged.
...
4. It builds a separate preview. The original scene, gameplay scripts, and game's build list stay unchanged.
